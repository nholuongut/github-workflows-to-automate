...
The following information provides a set of guidelines for contributing to the **nholuongut/github-workflows-to-automate** chain main repo. Use your best judgment, and, if you see room for improvement, please propose changes to this document.
...
1. [Fork the repository](https://github.com/nholuongut/github-workflows-to-automate).
...
8. Next, rinse and repeat the following:
    ...
    3. Create a PR on the **awesome-workflow** repository. There should be a PR template to help you do so.
